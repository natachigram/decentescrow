...
export function loadConfig() {
  ...
  if (!fs.existsSync(p)) throw new Error('Missing config/config.json. Copy from config.example.json')
...
export function getSigner() {
  ...
  if (!jwkPath) throw new Error('Set WALLET_PATH in .env to your Arweave JWK file')
